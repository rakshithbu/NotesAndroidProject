...
import com.example.mynotes.adapters.CategoriesAdapters;
...
public class Catogories extends AppCompatActivity {
    ...
    private void addNewCategory() {
        ...
        String url = "http://alllinks.online/andproject/addCategory.php?email="+ LoginHelper.getSharedPreferenceString(getApplicationContext(),"username","")+"&name="+ newCategory.getText().toString();
    ...
    public static void updateView(Categories[] cats)
    {
        ...
        CategoriesAdapters adapter = new CategoriesAdapters(cats,mContext);
    ...
    public static void updateCategory(final String val, final int id, final int pos)
    {
        ...
        HTTPRequestHelper.getInstance(mContext).addToRequestQueue(jsonObjReq);
    }
